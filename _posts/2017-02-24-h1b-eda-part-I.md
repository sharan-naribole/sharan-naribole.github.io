...
We can observe that there exist Worksite values that have spelling errors. Next, I implement a probabilistic spell-corrector that corrects Worksite values with errors at a maximum of distance.
